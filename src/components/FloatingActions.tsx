            ...
            <div className="p-5">
              <div className="bg-bg-soft rounded-xl p-3 mb-4">
                <p className="text-[0.85rem] text-text leading-relaxed">
                  Hallo! Haben Sie eine Frage zu Ihrem Website-Projekt? Schreiben Sie mir direkt per WhatsApp.
                </p>
              </div>
              <a
                href={`https://wa.me/${waNumber}?text=${encodeURIComponent("Hallo, ich habe eine Frage zu meinem Website-Projekt.")}`}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full py-3 rounded-full bg-[#25D366] text-white
                  font-semibold text-[0.88rem] hover:-translate-y-0.5 hover:shadow-[0_4px_16px_rgba(37,211,102,0.4)]
